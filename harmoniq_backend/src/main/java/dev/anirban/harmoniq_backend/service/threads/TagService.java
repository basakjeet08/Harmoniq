...
public class TagService {
    ...
    private List<Tag> createTags(List<String> relevantTagString, Map<String, Tag> tagLookupTable, User user) {
        log.info("(|) - Creating new tag entries with names : {}", relevantTagString.toString());
    ...
    public List<Tag> getRelevantTags(Thread thread, User user) {
        ...
        List<String> relevantTagString = generateTagStrings(thread.getDescription(), mergedTagString.toString());
        return createTags(relevantTagString, tagLookupTable, user);
    }
