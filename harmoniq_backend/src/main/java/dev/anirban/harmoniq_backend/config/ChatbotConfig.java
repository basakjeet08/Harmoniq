...
public class ChatbotConfig {
    ...
    private static final String CHATBOT_SYSTEM_MESSAGE = """
            ...
            Keep your tone **warm and human-like**, offering **concise but meaningful** replies (around 30-40 words).
            If a user seeks a **detailed response**, provide one with care and depth.
            
            Avoid overly robotic or detached answers—your goal is to **make the user feel heard and understood**.
            Ensure responses are **professional yet comforting**, as if speaking to a real patient in a therapy session.
            """;
    ...
    private static final String TAG_SYSTEM_MESSAGE = """
            ...
            The previous tags would be provided to you from the user prompt if there are any
            Select **three most relevant** tags from the existing list.
            If no suitable tags exist, generate new ones based on the thread description.
